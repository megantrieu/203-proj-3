...
public class LionNotFull extends Lion{

    public LionNotFull(String id, int resourceLimit,
                                    ...
                                    EventScheduler scheduler, ImageStore imageStore)
    {
        ...
        {
            ActiveEntity Lion = new LionFull(this.id, this.resourceLimit,
            ...
            Lion.scheduleActions(scheduler, world, imageStore);
    ...
    protected boolean moveTo(WorldModel world, Entity target, EventScheduler scheduler)
    {
        ...
        {
            Point nextPos = this.nextPositionLion(world, target.position);
